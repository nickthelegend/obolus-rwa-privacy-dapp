...
|------|-----|--------------|
| Primary | `#ccff00` | `--color-primary` |
| Secondary | `#000000` | `--color-background-dark` |
| Accent | `#85A1FF` | `--color-accent` |
...
- **Heading Font:** Inter
- **Body Font:** Inter
- **Mood:** high-contrast, technical, neon, bold, secure, cinematic
